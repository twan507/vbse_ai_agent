...
| 2026-07-28 | invest_memo | invest_memo/2026-08_cycle/tier2_20260728_rev3_draft.md | md | draft | 18 mã: CK (VIX/SSI/VND/SHS/MBS/VCI) · BĐS (CEO/DXG/HDG/KDH/NLG/DXS/TAL) · NH (SHB/MBB/CTG/STB/LPB/MSB) → (điền kỳ sau) | CP3 rev3, chờ user confirm. Rà tin đủ 5 ngành bằng 5 subagent. Loại CTS, TPB, ACB (nợ nhóm 2 +93,4%), BID (pha loãng 6,84% trong horizon); thêm VCI (Tô Hải mua 31 triệu cp 04/08-02/09), STB, LPB, MSB. Rút hẳn Hóa chất Phân bón — đỉnh chu kỳ |
