...
| 2026-07-28 | invest_memo | invest_memo/2026-08_cycle/tier2_20260728_rev2_draft.md | md | draft | 16 mã: CK (VIX/VND/SSI/SHS/MBS/CTS) · BĐS (HDG/KDH/DXS/NLG) · NH (SHB/TPB/MBB/CTG/ACB/BID) → (điền kỳ sau) | CP3 rev2, chờ user confirm. Sửa nhóm BĐS sau phản hồi user: loại DIG (hết cổ đông lớn, giải chấp, ICR −0,8 quý gần nhất), IJC (vòng quay 31,2 thấp nhất, không có coverage), HDC (ICR âm 3 quý liên tiếp), NVL (chậm trả nợ gốc trái phiếu 23/07) |
